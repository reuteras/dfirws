...
Add-Shortcut -SourceLnk "${HOME}\Desktop\dfirws\Files and apps\Log\MasterParser.lnk" -DestinationPath "${CLI_TOOL}" -WorkingDirectory "${GIT}\MasterParser" -Arguments "${CLI_TOOL_ARGS} -command .\MasterParser.ps1 -o Menu"
