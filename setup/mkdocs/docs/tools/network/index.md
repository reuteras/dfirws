...
| --- | --- | --- | --- | --- | --- |
| [Burp Suite](burp-suite.md) | Winget | Burp Suite is an integrated platform for performing security testing of web applications. It provides a wide range of tools for intercepting HTTP traffic, analyzing web applications, and automating security testing tasks. | web, security-testing, network |  | Full only |
| [Flare-Fakenet-NG](flare-fakenet-ng.md) | GitHub Release | FakeNet-NG - Next Generation Dynamic Network Analysis Tool | malware-analysis, network, dynamic-analysis | `.pcap` |  |
| [Microsoft.etl2pcapng](microsoft-etl2pcapng.md) | Winget | Microsoft.etl2pcapng is a tool for converting ETL (Event Trace Log) files to PCAPNG format, allowing you to analyze network traffic captured in ETL files using tools like Wireshark. | network-analysis, pcap, protocol-analysis | `.etl` |  |
...
| [Nmap](nmap.md) | HTTP | Nmap is a network exploration and security auditing tool. | network-analysis, security-testing, osint |  |  |
| [Npcap](npcap.md) | HTTP | Npcap packet capture driver installer. | network-analysis, pcap | `.pcap`, `.pcapng` |  |
