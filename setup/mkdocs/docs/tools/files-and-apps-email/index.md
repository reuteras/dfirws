...
| [PST Walker](pst-walker.md) | HTTP | PST Walker is a tool for analyzing PST files. | email, forensics | `.pst` |  |
| [extract-msg](extract-msg.md) | Python | Extracts emails and attachments saved in Microsoft Outlook's .msg files | email, data-extraction | `.msg` |  |
| [mboxviewer](mboxviewer.md) | GitHub Release | A small but powerful app for viewing MBOX files. | email, forensics | `.mbox`, `.eml` |  |