...
| [DBeaver](dbeaver.md) | GitHub Release | DBeaver is a database management tool. | database, gui | `.db`, `.sqlite`, `.sqlite3`, `.sql` |
| [Neo4j](neo4j.md) | HTTP | Neo4j is a graph database. | database, graph, visualization |  |
