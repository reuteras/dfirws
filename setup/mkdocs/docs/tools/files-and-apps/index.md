...
| [Detect It Easy](detect-it-easy.md) | GitHub Release | Detect It Easy is a tool for identifying file types and detecting packers. | pe-analysis, file-analysis, packer-detection | `.exe`, `.dll`, `.elf`, `.mach-o`, `.bin` |  |
...
| [QEMU](qemu.md) | Winget | QEMU is a generic and open-source machine emulator and virtualizer. It can be used to run operating systems and applications for different architectures on a host system, making it useful for testing, development, and analysis. | emulation | `.qcow2`, `.vmdk`, `.vdi`, `.img`, `.iso` | Full only |
| [TrID](trid.md) | HTTP | TrID is a file identifier utility. | file-analysis |  |  |
| [WinMerge](winmerge.md) | Winget | WinMerge is a visual file and directory comparison tool that helps you compare files and directories. It is useful for identifying differences between files, merging changes, and synchronizing directories. | binary-diffing |  |  |
