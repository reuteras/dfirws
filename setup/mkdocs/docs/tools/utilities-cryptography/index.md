...
| [Gpg4win](gpg4win.md) | HTTP | Gpg4win provides GnuPG and related tools for Windows. | encryption | `.gpg`, `.asc`, `.pgp` |  |
| [VeraCrypt](veracrypt.md) | HTTP | VeraCrypt is a disk encryption tool. | encryption, disk-forensics | `.hc`, `.tc` | Full only |
