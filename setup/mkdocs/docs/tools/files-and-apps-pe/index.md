...
| [HollowsHunter](hollowshunter.md) | GitHub Release | Scans running processes. Recognizes and dumps a variety of in-memory implants | malware-analysis, pe-analysis, dynamic-analysis | `.exe`, `.dll`, `.dmp` |  |
| [PE-bear](pe-bear.md) | GitHub Release | A tool for analyzing PE files | pe-analysis, reverse-engineering | `.exe`, `.dll`, `.sys` |  |
| [PE-sieve](pe-sieve.md) | GitHub Release | Scans a given process. Recognizes and dumps a variety of potentially malicious implants (replaced/injected PEs, shellcodes, hooks, in-memory patches). | pe-analysis, malware-analysis, dynamic-analysis | `.exe`, `.dll` |  |
...
| [WinObjEx64](winobjex64.md) | GitHub Release | WinObjEx64 is an advanced utility that lets you explore the Windows Object Manager namespace. | windows, debugging |  |  |
| [capa](capa.md) | GitHub Release | capa rules for identifying capabilities in binaries. | malware-analysis, pe-analysis, reverse-engineering, mitre-attack | `.exe` |  |
| [capa Explorer Web](capa-explorer-web.md) | HTTP | capa Explorer Web is a web UI for exploring capa results. | malware-analysis, visualization | `.exe`, `.dll` | Full only |
