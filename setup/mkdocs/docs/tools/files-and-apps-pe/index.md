...
| [WinObjEx64](winobjex64.md) | GitHub Release | WinObjEx64 is an advanced utility that lets you explore the Windows Object Manager namespace. | windows, kernel, debugging |  |  |
...
| [capa Explorer Web](capa-explorer-web.md) | HTTP | capa Explorer Web is a web UI for exploring capa results. | malware-analysis, capability-analysis, visualization | `.exe`, `.dll` | Full only |
