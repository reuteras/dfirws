...
- Change the default programs to install during startup in *local\config.txt*. Copy the file *local\defaults\config.txt* to *local\config.txt* and edit the file to set your own defaults.
