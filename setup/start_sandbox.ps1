...
Add-shortcut -SourceLnk "${HOME}\Desktop\dfirws\Files and apps\dumpbin.lnk" -DestinationPath "${POWERSHELL_EXE}" -WorkingDirectory "${HOME}\Desktop"
...
Add-Shortcut -SourceLnk "${HOME}\Desktop\dfirws\Zimmerman\Zimmerman.lnk" -DestinationPath "${TOOLS}\Zimmerman"
