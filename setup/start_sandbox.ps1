...
Add-Shortcut -SourceLnk "$HOME\Desktop\dfirws\Memory\Volatility Workbench 2.1" -DestinationPath "$POWERSHELL_EXE" -WorkingDirectory "$TOOLS\VolatilityWorkbench2" -Iconlocation "$TOOLS\VolatilityWorkbench2\VolatilityWorkbench    .exe"
Add-Shortcut -SourceLnk "$HOME\Desktop\dfirws\Memory\Volatility Workbench 3" -DestinationPath "$POWERSHELL_EXE" -WorkingDirectory "$TOOLS\VolatilityWorkbench" -Iconlocation "$TOOLS\VolatilityWorkbench\VolatilityWorkbench.exe"
