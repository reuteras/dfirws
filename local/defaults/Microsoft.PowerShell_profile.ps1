...
$env:GHIDRA_INSTALL_DIR = "C:\Tools\ghidra\" + ((Get-ChildItem C:\Tools\ghidra\ | findstr.exe PUBLIC | Select-Object -Last 1).Split(" ") | Select-Object -Last 1)
