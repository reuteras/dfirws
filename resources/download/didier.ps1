...
# ============================================================================
# This legacy script has been replaced by: install-all-tools-v2.ps1 -DidierStevensTools
#
# To use v2: .\downloadFiles.ps1 -Didier
# Or directly: .\resources\download\install-all-tools-v2.ps1 -DidierStevensTools
#
