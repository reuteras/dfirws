...
Try {
    ...
    Get-FileFromUri -uri "https://1.eu.dl.wireshark.org/win64/Wireshark-win64-4.0.3.exe" -FilePath ".\downloads\wireshark.exe"
    ...
    # Background image
    Get-FileFromUri -uri "https://images.contentstack.io/v3/assets/blt36c2e63521272fdc/blt5fe12bc93e60d63e/5fce9c4d752123476ba026d5/DFIR-cityscape.png" -FilePath ".\downloads\sans.png"
}
Catch {
