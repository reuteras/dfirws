...
# ============================================================================
# This legacy script has been replaced by: install-all-tools-v2.ps1 -NodeJsTools
#
# To use v2: .\downloadFiles.ps1 -Node
# Or directly: .\resources\download\install-all-tools-v2.ps1 -NodeJsTools
#
